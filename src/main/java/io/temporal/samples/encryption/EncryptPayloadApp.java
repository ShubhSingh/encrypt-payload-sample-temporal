...
/**
 * Encrypt Payload App that executes a single activity. Requires a local instance the Temporal
...
public class EncryptPayloadApp {
  ...
  private static final Logger log = LoggerFactory.getLogger(EncryptPayloadApp.class);
